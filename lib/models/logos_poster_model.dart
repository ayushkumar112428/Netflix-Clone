...
//
//     final logoPosterModel = logoPosterModelFromJson(jsonString);

import 'dart:convert';

LogoPosterModel logoPosterModelFromJson(String str) => LogoPosterModel.fromJson(json.decode(str));

String logoPosterModelToJson(LogoPosterModel data) => json.encode(data.toJson());

class LogoPosterModel {
  ...
  factory LogoPosterModel.fromJson(Map<String, dynamic> json) => LogoPosterModel(
